...
export const RevealBento = () => {
  return (
    <div className="bottom-0 px-4 py-12 min-h-80 top-2 bg-zinc-900 text-zinc-50">
      <motion.div
        initial="initial"
        animate="animate"
        transition={{
...
const AboutBlock = () => (
  <Block className="col-span-12 text-3xl leading-snug">
    <p>
      My passion is learning new skills.{" "}
      <span className="text-zinc-400">
        I'm slowly expanding my horizons in the world of development and web design.
      </span>
    </p>
  </Block>
);
